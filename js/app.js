...
stok:[
            {
                ...
                qty:28,
                safety:20,
                catatan: "Edisi 2024, cetak ulang" // <-- Tambahkan ini
            },
            {
                kode:"EKMA4115",
                ...
                qty:7,
                safety:15,
                catatan: "Cover baru" // <-- Tambahkan ini
            },
            {
                kode:"BIOL4201",
                ...
                qty:12,
                safety:10,
                catatan: "Butuh pendingin untuk kit basah" // <-- Tambahkan ini
            },
            {
                kode:"FISIP4001",
                ...
                qty:2,
                safety:8,
                catatan: "Stok menipis, prioritaskan reorder" // <-- Tambahkan ini
            }
        ],
